    ...
    return MainScaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          ListTile(
            leading: const Icon(Icons.add_circle_outline, color: Color(0xFF006C49)),
            title: const Text('Rút tiền'),
            onTap: () =>
                Navigator.pushNamed(context, '/lender/create-withdrawal'),
          ),
          ListTile(
            leading: const Icon(Icons.history, color: Color(0xFF006C49)),
            title: const Text('Lịch sử rút tiền'),
            onTap: () =>
                Navigator.pushNamed(context, '/lender/withdrawal-history'),
          ),
